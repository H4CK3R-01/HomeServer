$(function () {
    httpGetAsync('http://127.0.0.1:5000/api/v1/resources/device', "", showDevices);
...
$(document).on('click', '#save', function() {
    ...
    httpPostAsync("http://127.0.0.1:5000/api/v1/resources/device", data, add_result);
});
...
$(document).on('click', '.save', function () {
    ...
    httpPutAsync("http://127.0.0.1:5000/api/v1/resources/device/" + id, data, update_result);
});
...
$(document).on('click', '.delete', function () {
    ...
    httpDeleteAsync("http://127.0.0.1:5000/api/v1/resources/device/" + id, "", delete_result);
});
